...
return new class extends Migration
{
    ...
    {
        Schema::create('stock_mill_return_items', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('stock_mill_return_id')->nullable();
            ...
            $table->index(['stock_mill_return_id', 'wis_id', 'warehouse_item_id', 'item_id', 'item_type_id'], 'stock_mill_return_item_lookup_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('stock_mill_return_items');
    }
};
