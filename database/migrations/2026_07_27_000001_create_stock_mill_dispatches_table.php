...
return new class extends Migration
{
    ...
    {
        Schema::create('stock_mill_dispatches', function (Blueprint $table) {
            ...
            $table->string('dispatch_item_name', 255)->nullable();
            $table->integer('dispatch_item_type_id')->nullable();
            ...
            $table->integer('changed_status_by')->nullable();
    ...
    {
        Schema::dropIfExists('stock_mill_dispatches');
    }
};
