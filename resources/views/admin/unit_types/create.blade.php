...
<div class="content-wrapper"><section class="content-header"><div class="header-icon"><i class="fa fa-balance-scale"></i></div><div class="header-title"><h1>Add Unit</h1><small>Define a measurement identity</small></div></section>
...
{!! display_message('message') !!}<form method="POST" action="{{ route('admin.unit-types.store') }}">@csrf @include('admin.unit_types._form', ['unitType' => null])</form>
