		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<div class="header-title">
					<h1>Edit Unit Types</h1><small>Unit Types</small>
				</div>
			</section>
					...
					<div class="col-sm-12">
						<div class="panel panel-bd lobidrag">
							...
							<div class="panel-body">
								...
								<form method="POST" action="{{ route('admin.unit-types.update', enc($unitType->unit_type_id)) }}">
									@csrf
									@method('PUT')
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group"><label>Unit Type Name <span class="required">*</span></label><input type="text" name="unit_type_name" value="{{ old('unit_type_name', $unitType->unit_type_name) }}" class="form-control" required></div>
										</div>
										<div class="col-sm-4">
											<div class="form-group"><label>Status</label><select name="status" class="form-control">
													@include('admin.common.status-options', ['selectedStatus' => $unitType->status])
												</select></div>
										</div>
									</div>
