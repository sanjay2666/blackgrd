						...
						<div class="panel panel-bd lobidrag">
							...
							<div class="panel-body">
								...
								<form method="POST" action="{{ route('admin.item-yarn-requirements.update', enc($itemYarnRequirement->id)) }}">
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group"><label>Item Id <span class="required">*</span></label><input type="number" name="item_id" value="{{ old('item_id', $itemYarnRequirement->item_id) }}" class="form-control" step="any" required></div>
										</div>
										<div class="col-sm-4">
											<div class="form-group"><label>Yarn Id <span class="required">*</span></label><input type="number" name="yarn_id" value="{{ old('yarn_id', $itemYarnRequirement->yarn_id) }}" class="form-control" step="any" required></div>
										</div>
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<div class="form-group"><label>Yarn Quantity</label><input type="number" name="yarn_quantity" value="{{ old('yarn_quantity', $itemYarnRequirement->yarn_quantity) }}" class="form-control" step="any"></div>
										</div>
										<div class="col-sm-4">
											<div class="form-group"><label>Unit <span class="required">*</span></label><input type="text" name="unit" value="{{ old('unit', $itemYarnRequirement->unit) }}" class="form-control" required></div>
										</div>
										<div class="col-sm-4">
											<div class="form-group"><label>Process Id <span class="required">*</span></label><input type="number" name="process_id" value="{{ old('process_id', $itemYarnRequirement->process_id) }}" class="form-control" step="any" required></div>
										</div>
										<div class="col-sm-4">
