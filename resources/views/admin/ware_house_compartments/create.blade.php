...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header"><div class="header-icon"><i class="fa fa-list"></i></div><div class="header-title"><h1>Add Warehouse Compartments</h1><small>Warehouse Compartments</small></div></section>
            <section class="content"><div class="row"><div class="col-sm-12"><div class="panel panel-bd lobidrag">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('admin.ware-house-compartments.store') }}">
                        @csrf
                        <div class="row">
