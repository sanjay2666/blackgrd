...
<a href="{{ route('admin.dashboard') }}" class="logo">
   ...
   <span class="logo-lg">
   <img src="{{ asset('assets/brand/loomexa-logo.svg') }}" alt="">
   </span>
</a>
<!-- Header Navbar -->
 ...
 <div class="navbar-custom-menu">
	  <ul class="nav navbar-nav">
		 ...
		 <li class="dropdown messages-menu">
			<a href="javascript:void(0);" class="dropdown-toggle admin-notification" data-toggle="dropdown"> 
		 ...
		 <li class="dropdown dropdown-user">
			...
			<ul class="dropdown-menu" >
			   ...
			   <li><form method="POST" action="{{ route('admin.logout') }}">@csrf<button type="submit" class="btn btn-link" style="padding: 10px 20px; color: #333; text-decoration: none;"><i class="fa fa-sign-out"></i> Signout</button></form></li>
			</ul>
		 </li>
	  </ul>
   </div>
