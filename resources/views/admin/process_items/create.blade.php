                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('admin.process-items.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"><div class="form-group"><label>Process Name <span class="required">*</span></label><input type="text" name="process_name" value="{{ old('process_name') }}" class="form-control" required>@error('process_name')<span class="text-danger small">{{ $message }}</span>@enderror</div></div>
                            ...
                            <div class="col-sm-3"><div class="form-group"><label>Last Sl No <span class="required">*</span></label><input type="number" name="process_sl_no_last" value="{{ old('process_sl_no_last', 0) }}" class="form-control" required>@error('process_sl_no_last')<span class="text-danger small">{{ $message }}</span>@enderror</div></div>
