                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('admin.item-types.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4"><div class="form-group"><label>Short Code <span class="required">*</span></label><input type="text" name="short_code" value="{{ old('short_code') }}" class="form-control" maxlength="30" pattern="[A-Za-z0-9_-]+" required></div></div>
                            <div class="col-sm-4">
