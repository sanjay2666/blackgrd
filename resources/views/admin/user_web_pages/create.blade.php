...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header"><div class="header-icon"><i class="fa fa-list"></i></div><div class="header-title"><h1>Add User Web Pages</h1><small>User Web Pages</small></div></section>
            <section class="content"><div class="row"><div class="col-sm-12"><div class="panel panel-bd lobidrag">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('admin.user-web-pages.store') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-4"><div class="form-group"><label>Page Id <span class="required">*</span></label><input type="number" name="page_id" value="{{ old('page_id') }}" class="form-control" step="any" required></div></div>
