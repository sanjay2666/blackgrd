...
<head>
	@include('frontend.common.head', ['pageTitle' => 'Dashboard | Loomexa'])
</head>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<div class="header-title">
					<h1>Loomexa Dashboard</h1>
					<small>Textile production ERP overview.</small>
				</div>
			</section>
			<!-- Main content -->
						...
						<div class="panel panel-bd lobidisable">
							...
							<div class="panel-body">
								...
								<div class="detailswork">
									...
									<a href="javascript:void(0);" title="headings">Marketing policy</a> <br>
								...
								<div class="detailswork">
									...
									<a href="javascript:void(0);" title="headings">Accounting policy</a> <br>
									<p>Kolkata, India</p>
								</div>
								<div class="work-touchpoint">
								...
								<div class="detailswork">
									...
									<a href="javascript:void(0);" title="headings">Finance policy</a> <br>
						...
						<div class="panel panel-bd lobidisable">
							...
							<div class="panel-body">
								<div class="runnigwork">
									...
									<a href="javascript:void(0);">Database configuration</a><br>
								...
								<div class="runnigwork">
									...
									<i class="fa fa-dot-circle-o"></i>
									<a href="javascript:void(0);">Design tool</a><br>
									<div class="progress runningprogress">
								...
								<div class="runnigwork">
									...
									<i class="fa fa-dot-circle-o"></i>
									<a href="javascript:void(0);">Internet configuration</a><br>
									<div class="progress runningprogress">
								...
								<div class="runnigwork">
									...
									<i class="fa fa-dot-circle-o"></i>
									<a href="javascript:void(0);">Banner completation</a><br>
									<div class="progress runningprogress">
								...
								<div class="runnigwork">
									...
									<i class="fa fa-dot-circle-o"></i>
									<a href="javascript:void(0);">IT Solution</a><br>
									<div class="progress runningprogress">
						...
						<div class="panel panel-bd lobidisable">
							...
							<div class="panel-body">
								<div class="Pendingwork">
									<span class="label-warning label label-default pull-right">progressing</span>
									<i class="fa fa-ban"></i>
									<a href="javascript:void(0);">Database tools</a>
								...
								<div class="Pendingwork">
									<span class="label-success label label-default pull-right">success</span>
									<i class="fa fa-ban"></i>
									<a href="javascript:void(0);">Cabels</a>
									<div class="upworkdate">
								...
								<div class="Pendingwork">
									<span class="label-danger label label-default pull-right">Failed</span>
									<i class="fa fa-ban"></i>
									<a href="javascript:void(0);">Technologycal tools</a>
									<div class="upworkdate">
								...
								<div class="Pendingwork">
									<span class="label-success label label-default pull-right">success</span>
									<i class="fa fa-ban"></i>
									<a href="javascript:void(0);">Training tools</a>
									<div class="upworkdate">
