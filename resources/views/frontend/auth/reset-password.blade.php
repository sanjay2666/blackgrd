...
<head>
    ...
    <title>Reset Password | Loomexa</title>
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $email) }}" class="form-control" placeholder="example@gmail.com" required>
                    ...
                    <div class="form-group">
                        ...
                        <span class="help-block small">Minimum 8 characters</span>
