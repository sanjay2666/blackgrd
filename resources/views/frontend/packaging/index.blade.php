                        ...
                        <div class="workorder-filter-wrap">
                            <div class="workorder-filter-box">
                                <form method="get" action="{{ route('packaging.show-available-orders') }}" role="search" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-6"><div class="input-group input-group-sm"><span class="input-group-addon"><i class="fa fa-list-alt"></i></span><input class="form-control" name="quality" id="packaging-quality" value="{{ request('quality') }}" placeholder="Quality"></div></div>
                                        ...
                                        <div class="col-md-2 col-sm-6"><div class="input-group input-group-sm"><span class="input-group-addon"><i class="fa fa-calendar"></i></span><input class="form-control" type="date" name="from_date" id="packaging-from-date" value="{{ request('from_date') }}" title="Delivery From Date"></div></div>
                                        <div class="col-md-2 col-sm-6"><div class="input-group input-group-sm"><span class="input-group-addon"><i class="fa fa-calendar"></i></span><input class="form-control" type="date" name="to_date" id="packaging-to-date" value="{{ request('to_date') }}" title="Delivery To Date"></div></div>
