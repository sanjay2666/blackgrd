          ...
          <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body"> 
              <div class="table-responsive">
			   ...
			   <form method="post" action="{{ route('StoreWarehouseYarnStockAllotment') }}" class="form-horizontal" id="stockAllotFormYarn" autocomplete="off">
			    <div class="col-sm-12">
				...
				?>
							...
							<tr>
								...
								<td class="text-left"><?=$warehouseName['WarehouseCompartment']; ?> 
				...
				<?php } ?>
				<?php if (!empty($flag)) { ?>
					<button type="submit" id="submitBtnYarn" class="btn btn-success pull-left">Update Allotment</button>
				<?php } ?>
			</form>
